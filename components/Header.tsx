...
//         {/* Desktop Links */}
//         <div className="hidden md:flex text-sm items-center space-x-6 text-black">
...
//         {/* Mobile Links */}
//         <div className="flex md:hidden text-sm items-center space-x-4 text-black">
...
//               type="text"
//               placeholder="Search"
//               className="w-full text-blackrounded-full pl-10 pr-4 py-2 text-sm focus:outline-none"
//             />
